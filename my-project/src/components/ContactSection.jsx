...
const ContactSection = () => {
     ...
     const ValidateFom=()=>{
        if(!formData.name.trim() || !formData.name.trim() || !formData.email.trim() ||  !formData.subject.trim() || !formData.message.trim() ){
    ...
    return (
       ...
       <div className=" my-5 mt-6 max-w-6xl max-lg:max-w-3xl xl:w-[100%] mx-auto bg-gray-100 rounded-lg dark:text-black ">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 className="text-4xl font-bold dark:text-black ">Contactez-nous</h1>
                    ...
                    <ul className="mt-12 space-y-8">
                        <li className="flex items-center">
                            <svg className="" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#000'
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="bg-[#009B72] hover:bg-[#009B72]/75 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="">
                        ...
                        <li className="bg-[#009B72] hover:bg-[#009B72]/75h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                    viewBox="0 0 24 24">
                                    <path
      ...
      <button
        type="button"
        onClick={() => handleClick("Web mobile")}
        className={`px-4 py-2 rounded-lg text-sm tracking-wider font-medium outline-none border-2 mr-4 ${
          activeButton === "Web mobile"
            ? "bg-[#009B72] text-white hover:bg-[#009B72]/75"
        ...
        Graphic design
                    ...
                    <form className="mt-8 space-y-4">
                        <input onChange={(e)=>handleChangeInputs(e)} name="name" type='text'  placeholder='Name'
                            className=" bg-gray-200 w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <input onChange={(e)=>handleChangeInputs(e)} name="email" type='email'  placeholder='Email'
                            className=" bg-gray-200  w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <input onChange={(e)=>handleChangeInputs(e)} name="subject" type='text' placeholder='Subject'
                            className=" bg-gray-200  w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <textarea   onChange={(e)=>handleChangeInputs(e)} name="message"   placeholder='Message'  rows="6"
                            className=" bg-gray-200  w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#009B72]"></textarea>
