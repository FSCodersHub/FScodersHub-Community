...
const ContactSection = () => {
    ...
    return (
       <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-gray-100 rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    ...
                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-[#009B72] hover:bg-[#009B72]/75 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <li class="bg-[#009B72] hover:bg-[#009B72]/75h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                    viewBox="0 0 24 24">
                                    <path
        ...
        Graphic design
                    ...
                    <form class="mt-8 space-y-4">
                        <input type='text' placeholder='Name'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <input type='email' placeholder='Email'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <input type='text' placeholder='Subject'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#009B72]" />
                        <textarea placeholder='Message' rows="6"
                            class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#009B72]"></textarea>
                        <button type='button'
                            class="text-white bg-[#009B72] hover:bg-[#009B72]/75 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
