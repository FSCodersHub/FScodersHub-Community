...
//     return (
//         <div className="grid sm:grid-cols-2 items-start gap-16 p-6 mx-auto max-w-4xl bg-white font-sans">
//             <div className="md:flex md:items-center md:h-full md:justify-center">
//                 <h1 className="text-gray-800 text-3xl font-extrabold">Contactez-nous</h1>
//             </div>
...
//                     type="text" 
//                     placeholder="Nom" 
//                     className="w-full text-gray-800 rounded-md py-3 px-4 border border-gray-300 text-sm focus:border-emerald-500 focus:ring-emerald-500"
//                 />
...
//                     placeholder="Message" 
//                     rows="6" 
//                     className="w-full text-gray-800 rounded-md px-4 py-3 border border-gray-300 text-sm focus:border-emerald-500 focus:ring-emerald-500"
//                 ></textarea>
                
//                 <button 
//                     type="submit" 
//                     className="text-white bg-emerald-600 hover:bg-emerald-700 rounded-md text-sm px-4 py-3 w-full mt-6 transition duration-200"
//                 >
//                     Envoyer
//                 </button>
//             </form>
